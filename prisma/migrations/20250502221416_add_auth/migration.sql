/*
  ...
  - You are about to drop the column `articleUrl` on the `Lecture` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "Lecture" DROP COLUMN "articleUrl",
...
-- AddForeignKey
ALTER TABLE "Progress" ADD CONSTRAINT "Progress_pseudoUserId_fkey" FOREIGN KEY ("pseudoUserId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
