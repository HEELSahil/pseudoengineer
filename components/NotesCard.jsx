...
const NotesCard = ({ title, imgSrc, href }) => (
    <div className="p-4 md:w-1/3" style={{ maxWidth: '544px' }}>
        <div className={`${ imgSrc && 'h-full'} overflow-hidden rounded-2xl border-2 border-gray-300 border-opacity-60 dark:border-gray-700`}>
            <Image
                alt={title}
                src={imgSrc}
